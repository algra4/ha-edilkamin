...
class EdilkaminAsyncApi:
    ...
    def __init__(self, mac_address, username: str, password:str, hass: HomeAssistant):
    ...
    async def set_temperature(self, value):
        ...
        await self.execute_command(
            {"name": "enviroment_1_temperature", "value": value}
        )
